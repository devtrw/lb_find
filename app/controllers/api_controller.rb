  ...
  def longboarder
    render text: {
        longboarders: [
          ...
          { location: 'Phoenix, AZ', dicipline: [:downhill, :freeride], username: 'patrike12', age: 23 },
          ...
          { location: 'New York, New York', dicipline: [:cruising], username: 'evanli123', age: 1 },
          ...
          { location: 'Los Angeles, CA', dicipline: [], username: 'MrFrodoo', age: 43 },
        ],
