  ...
  def longboarder
    render text: {
        longboarders: [
          ...
          { location: 'Portland, OR', discipline: [:downhill], username: 'some_dude_4', age: 25 },
          { location: 'Portland, OR', discipline: [:downhill], username: 'some_dude_3', age: 25 },
          { location: 'Portland, OR', discipline: [:downhill], username: 'some_dude_2', age: 25 },
          ...
          { location: '97219', discipline: [:cruising, :dancing], username: 'pdx_longboarder_420', age: 93 },
